...
namespace Bililive_dm
{
    ...
    public class StoreModel : INotifyPropertyChanged
    {
        ...
        public String MainFontFamily{
            get{
                return _mainfontmanliy;
            }
            set{
                if (value == _mainfontmanliy) return;
                Store.MainFontFamily = _mainfontmanliy=value;
                OnPropertyChanged();
            }
        }
        ...
        public  String _mainfontmanliy;   //设置字体
        ...
        public StoreModel()
        {
            ...
            _mainfontmanliy = Store.MainFontFamily;
        }
