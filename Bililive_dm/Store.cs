...
namespace Bililive_dm
{
    public static class Store
    {
        ...
        public static double MainOverlayEffect1 = 0; //拉伸
        public static double MainOverlayEffect2 = 0.0; //文字出現
        public static double MainOverlayEffect3 = 5 - 1.4; //文字停留
        public static double MainOverlayEffect4 = 1; //窗口消失
        public static double MainOverlayFontsize = 18.667;
        public static String MainFontFamily = "Microsoft YaHei UI";   //设置字体
    ...
    public static class DefaultStore
    {
        ...
        public static double MainOverlayEffect4 = 1; //窗口消失
        public static double MainOverlayFontsize = 18.667;
        public static String MainFontFamily = "黑体";   //设置字体
